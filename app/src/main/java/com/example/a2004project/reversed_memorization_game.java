...
public class reversed_memorization_game extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reversed_memorization_game);
        textbox = findViewById(R.id.rev_mem_textbox);
        input_box = findViewById(R.id.rev_mem_num_box);
        handler = new Handler();
        ...
        tick = findViewById(R.id.rev_mem_tick);
        cross = findViewById(R.id.rev_mem_cross);
        tick.setVisibility(View.INVISIBLE);
        cross.setVisibility(View.INVISIBLE);

        Toolbar toolbar = findViewById(R.id.toolbar_rev_memorization_game);
        ...
        if (MainMenu.lang!="English"){
            ...
            Button buton;
            buton=findViewById(R.id.rev_mem_game_buttonn);
            buton.setText("Tamam");
        }
    ...
    public void evaluate(View view) {
        if (showed){
            ...
            StringBuilder reversed = new StringBuilder(user_answer);
            user_answer = reversed.reverse().toString();
